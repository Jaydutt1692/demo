...
//           <h2 className="sections--heading">Below are the Certifications:</h2>
//         </div>
//       </div>
      ...
      <div className="certifications--section--container">
        {data?.certifications?.map((item, index) => (
          <div key={index} className="certifications--section--card">
            <div className="certifications--section--card--img">
              <img src={item.src} alt="Certificate" className="certificate-image" />
            </div>
